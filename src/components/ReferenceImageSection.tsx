...
// ─── Lightbox (with zoom + drag-to-pan, matching existing page behaviour) ────
...
export function ReferenceImageSection({ rowSlug }: ReferenceImageSectionProps) {
  ...
  // ── Both images uploaded → full slider ──────────────────────────────────────
    ...
    return (
      <>
        <BeforeAfterSlider
          beforeSrc={beforeSrc}
          afterSrc={afterSrc}
          onRemoveBefore={handleRemoveBefore}
          onRemoveAfter={handleRemoveAfter}
